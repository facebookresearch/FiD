...
from retriever.tokenizer import SimpleTokenizer
...
def calculate_matches(data: List, workers_num: int, match_type = 'string') -> QAMatchStats:
    """
...
def check_answer(example, tokenizer, match_type) -> List[bool]:
